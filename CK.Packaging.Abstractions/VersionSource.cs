...
{
    /// <summary>
    /// This entry's own <see cref="AmbiguousDependency.Requirements"/>: the version is the greatest
    /// of them (NuGet's highest-wins). Nothing outside the closure anchors it.
    /// </summary>
    ...
    /// The <see cref="AmbiguousDependency.Requirements"/> are the ones asking for more.
    /// </summary>
    DirectDependencies,

    /// <summary>
    /// A <see cref="PublishedProfile.ProducedPackages"/> entry: this profile produces the identifier
    /// itself. The <see cref="AmbiguousDependency.Requirements"/> are the ones asking for another
    /// version.
    /// </summary>
    ProducedPackages
}

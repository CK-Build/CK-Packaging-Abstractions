...
public sealed class PublishedFolder
{
    ...
    sealed class FileCacheInfo
    {
        ...
        FileCacheInfo( SVersion version, string jsonFilePath, PublishedProfile? saved, Exception? loadError )
        {
            _version = version;
    ...
    /// <summary>
    /// Gets all the profiles, ordered by descending <see cref="PublishedProfile.Version"/> (the
    /// latest first). All the files are read.
    /// </summary>
